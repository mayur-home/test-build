...
var _spin = __webpack_require__(122);
...
router.get('/result', _spin2.default.result);
// More routes
// router.get('/xyz', SpinController.xyz)
...
exports.default = {
	result: function result(req, res) {
		res.json(generateResponse());
	}
	//,
	// additinal apis for spin route


	// Utility functions
};
function generateResponse() {
	var randomNumbers = getThreeRandomNumbers();
	return {
		"result": randomNumbers,
		"hasBonus": isBonus(),
		"winType": getWinType(randomNumbers)
	};
}
