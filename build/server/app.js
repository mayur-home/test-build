...
var callSiteToString = __webpack_require__(152).callSiteToString
var eventListenerCount = __webpack_require__(152).eventListenerCount
...
var contentDisposition = __webpack_require__(170);
...
var etag = __webpack_require__(171);
var proxyaddr = __webpack_require__(175);
var qs = __webpack_require__(112);
...
var setPrototypeOf = __webpack_require__(383)
...
var first = __webpack_require__(409)
...
var typer = __webpack_require__(411)
...
var codes = __webpack_require__(384)
...
var getBody = __webpack_require__(390)
var iconv = __webpack_require__(157)
var onFinished = __webpack_require__(58)
var zlib = __webpack_require__(410)
...
var destroy = __webpack_require__(426)
var encodeUrl = __webpack_require__(78)
var escapeHtml = __webpack_require__(79)
var etag = __webpack_require__(171)
var fresh = __webpack_require__(173)
var fs = __webpack_require__(51)
var mime = __webpack_require__(427)
var ms = __webpack_require__(155)
var onFinished = __webpack_require__(58)
var parseRange = __webpack_require__(174)
...
function loadParser (parserName) {
  ...
  switch (parserName) {
    case 'json':
      parser = __webpack_require__(382)
      break
    case 'raw':
      parser = __webpack_require__(414)
      break
    case 'text':
      parser = __webpack_require__(415)
      break
    case 'urlencoded':
      parser = __webpack_require__(416)
      break
  }
...
lazyProperty(module.exports, 'callSiteToString', function callSiteToString () {
  ...
  return stack[0].toString ? toString : __webpack_require__(380)
})

lazyProperty(module.exports, 'eventListenerCount', function eventListenerCount () {
  return EventEmitter.listenerCount || __webpack_require__(381)
})
...
var db = __webpack_require__(412)
...
var Layer = __webpack_require__(168);
var methods = __webpack_require__(113);
...
var pathRegexp = __webpack_require__(422);
...
var Stats = __webpack_require__(51).Stats
...
var forwarded = __webpack_require__(429)
var ipaddr = __webpack_require__(430)
...
var _morgan = __webpack_require__(444);
...
// from mentioned directory "./build/client/"
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(261));
...
var bodyParser = __webpack_require__(151)
var EventEmitter = __webpack_require__(153).EventEmitter;
var mixin = __webpack_require__(419);
var proto = __webpack_require__(420);
var Route = __webpack_require__(167);
var Router = __webpack_require__(166);
var req = __webpack_require__(432);
var res = __webpack_require__(439);
...
exports.query = __webpack_require__(169);
exports.static = __webpack_require__(443);
...
var bytes = __webpack_require__(55)
var contentType = __webpack_require__(75)
var createError = __webpack_require__(56)
...
var tty = __webpack_require__(389);
var util = __webpack_require__(110);
...
var createError = __webpack_require__(56)
var iconv = __webpack_require__(157)
var unpipe = __webpack_require__(160)
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(111).concat(__webpack_require__(158)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(111).concat(__webpack_require__(158)) },
        gb18030: function() { return __webpack_require__(404) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(159).concat(__webpack_require__(406)) },
...
var Buffer = __webpack_require__(22).Buffer,
    Transform = __webpack_require__(57).Transform;
...
module.exports = function (iconv) {
    ...
    iconv.extendNodeEncodings = function extendNodeEncodings() {
        ...
        // -- SlowBuffer -----------------------------------------------------------
        var SlowBuffer = __webpack_require__(22).SlowBuffer;
        ...
        if (iconv.supportsStreams) {
            var Readable = __webpack_require__(57).Readable;
...
var finalhandler = __webpack_require__(421);
var Router = __webpack_require__(166);
var methods = __webpack_require__(113);
var middleware = __webpack_require__(423);
var query = __webpack_require__(169);
var debug = __webpack_require__(18)('express:application');
var View = __webpack_require__(424);
var http = __webpack_require__(81);
...
mime.define(__webpack_require__(428));
...
var accepts = __webpack_require__(433);
var deprecate = __webpack_require__(29)('express');
var isIP = __webpack_require__(156).isIP;
var typeis = __webpack_require__(59);
var http = __webpack_require__(81);
var fresh = __webpack_require__(173);
var parseRange = __webpack_require__(174);
...
var Negotiator = __webpack_require__(434)
var mime = __webpack_require__(161)
...
function loadModule(moduleName) {
  ...
  switch (moduleName) {
    case 'charset':
      module = __webpack_require__(435);
      break;
    case 'encoding':
      module = __webpack_require__(436);
      break;
    case 'language':
      module = __webpack_require__(437);
      break;
    case 'mediaType':
      module = __webpack_require__(438);
      break;
    default:
...
var statuses = __webpack_require__(76)
var merge = __webpack_require__(82);
var sign = __webpack_require__(440).sign;
...
var cookie = __webpack_require__(441);
var send = __webpack_require__(116);
var extname = path.extname;
var mime = send.mime;
var resolve = path.resolve;
var vary = __webpack_require__(442);
...
var _spin = __webpack_require__(448);
...
exports.default = function () {
	...
	// assign spin route
	api.use('/spin', (0, _spin2.default)());

	// if no path match then safetly send an error
	// saying requested resource is not available
	api.use('/*', function (req, res) {
		res.json({
			error: "Sorry, requested resource is not available!"
		});
	});
...
var _util = __webpack_require__(449);
...
function generateResponse() {
	var randomNumbers = _util2.default.getThreeRandomNumbers();
	return {
		"result": randomNumbers,
		"hasBonus": _util2.default.getRandomBoolean(),
		"winType": _util2.default.getWinType(randomNumbers)
	};
}
...
exports.default = {
	getThreeRandomNumbers: function getThreeRandomNumbers() {
		var numbers = [];
		for (var i = 0; i <= 2; i++) {
	...
	/**
  * @description identify and return win level according to the number associated
  *  with graphics for each reel
  *
  * @function getWinType
  * @param {array} numbers
  * @returns {number} winType (Big Win | Small Win | No Win)
  * @memberof SlotMachineComponent
  */
	getWinType: function getWinType(numbers) {
		var uniqNumberSet = new Set(numbers);
		var winType = void 0;

		switch (uniqNumberSet.size) {
			case 1:
				winType = 'Big Win';
				break;
			case 2:
