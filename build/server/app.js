...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(67); // Lazy load all encoding definitions.
...
app.use('/casino-slot-game/', _express2.default.static('./build/client/'));
...
var read = __webpack_require__(14)
...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __webpack_require__(77) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(22).concat(__webpack_require__(35)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(22).concat(__webpack_require__(35)) },
        gb18030: function() { return __webpack_require__(79) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(36).concat(__webpack_require__(81)) },
...
var debug = __webpack_require__(0)('morgan')
var deprecate = __webpack_require__(2)('morgan')
var onFinished = __webpack_require__(9)
var onHeaders = __webpack_require__(121)
...
var _spin = __webpack_require__(123);
